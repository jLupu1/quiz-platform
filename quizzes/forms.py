...
class CreateQuizForm(forms.ModelForm):
    class Meta:
        model = Quiz
        # Make sure 'open_date' and 'close_date' match your actual field names!
        fields = ['course', 'name', 'introduction', 'open_date', 'close_date', 'time_limit', 'maximum_marks',
        ...
        # THE FIX: Force Django to use the HTML5 Date-Time picker
        widgets = {
